...
public final class PhotoItemBinding implements ViewBinding {
  ...
  private PhotoItemBinding(@NonNull FrameLayout rootView, @NonNull ImageButton btnRemovePhoto,
      @NonNull ImageView photoImage) {
  ...
  public static PhotoItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PhotoItemBinding((FrameLayout) rootView, btnRemovePhoto, photoImage);
    }
