...
echo "  npm run build      - Build the Android project"
echo "  npm run clean      - Clean build files"
echo "  npm run install-deps - Install/refresh dependencies"
echo "  npm run test       - Run tests"
echo "  npm run assemble   - Build APK"
echo "  npm run install    - Install APK to device"
echo ""
echo "Or use Gradle directly:"
echo "  ./gradlew build    - Build the project"
echo "  ./gradlew clean    - Clean the project"